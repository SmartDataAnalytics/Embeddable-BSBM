...
public class Generator {
    ...
    public static void writeTestDriverData() {
        TestDriverParams params = getTestDriverParams();
        writeTestDriverData(params);
    }


    public static void writeTestDriverData(TestDriverParams params) {
        ...
        try {
            ...
            productTypeOutput.writeObject(params.getProductTypeLeaves().toArray(new ProductType[0]));
            productTypeOutput.writeInt(params.getProductTypeCount());
            productTypeOutput.writeObject(params.getMaxProductTypeNrPerLevel());
        } catch(IOException e) {
        ...
        try {
            ...
            productProducerOutput.writeObject(params.getProducerOfProduct().toArray(new Integer[0]));
        } catch(IOException e) {
        ...
        try {
            ...
            offerVendorOutput.writeObject(params.getVendorOfOffer().toArray(new Integer[0]));
        } catch(IOException e) {
        ...
        try {
            ...
            reviewRatingsiteOutput.writeObject(params.getRatingsiteOfReview().toArray(new Integer[0]));
        } catch(IOException e) {
        ...
        try {
            ...
            currentDateAndLabelWordsOutput.writeInt(params.getProductCount());
            currentDateAndLabelWordsOutput.writeInt(params.getReviewCount());
            currentDateAndLabelWordsOutput.writeInt(params.getOfferCount());
            currentDateAndLabelWordsOutput.writeObject(params.getToday());
            currentDateAndLabelWordsOutput.writeObject(params.getWordList());
        } catch(IOException e) {
    ...
    public static TestDriverParams getTestDriverParams() {
        TestDriverParams result = new TestDriverParams();
        ...
        result
            ...
            .setProductTypeCount(productTypeCount)
            .setMaxProductTypeNrPerLevel(maxProductTypeNrPerLevel)
            .setProductTypeLeaves(productTypeLeaves)
            .setProductTypeNodes(productTypeNodes)
            .setProducerOfProduct(producerOfProduct)
            .setVendorOfOffer(vendorOfOffer)
            .setRatingsiteOfReview(ratingsiteOfReview)
